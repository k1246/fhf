  ...
  public  class GxBitmap
    {
      ...
      public GxBitmap(IGXDevice objIGXDevice, PictureBox objPictureBox)
      {
          ...
          m_objGC = m_pic_ShowImage.CreateGraphics();
            //m_objGC.DrawLine(new Pen(Color.Orange, 3), 400, 0, 400, 300);
            //m_objGC.DrawLine(new Pen(Color.Orange, 3), 0, 300, 800, 300);//第一条线
              ...
              if (GX_FRAME_STATUS_LIST.GX_FRAME_STATUS_SUCCESS == objIBaseData.GetStatus())
              {
                  ...
                  else
                  {
                      ...
                      byte[] byMonoBufferTmp = new byte[__GetStride(m_nWidth, m_bIsColor) * m_nHeigh];
                        ...
                        //MemoryStream stream = new MemoryStream(byMonoBufferTmp);

                        //Bitmap bitmap = new Bitmap(stream);
                        //Graphics grfx = Graphics.FromImage(bitmap);
                        //grfx.DrawLine(new Pen(Color.Orange, 3), 400, 0, 400, 300);//第一条线 
                        //grfx.DrawLine(new Pen(Color.Orange, 3), 0, 300, 400, 300);//第二条线           
                        //grfx.Dispose();
