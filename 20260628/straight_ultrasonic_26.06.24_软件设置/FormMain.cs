...
namespace FlatUI_TestPlatform
{
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            {
                Console.WriteLine($"Format error for AxisX: {ex.Message}, Value: {PubCls.MyIniFile.ReadData("Config", "AxisX", "", PubCls.MyIniFile.FilePath)}");
            }
            catch (OverflowException ex)
            {
                Console.WriteLine($"Overflow error for AxisX: {ex.Message}");
            }
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //250917调用子窗口的有参函数，所有的时钟设置都在有参构造里
